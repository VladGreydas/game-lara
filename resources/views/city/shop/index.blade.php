<x-app-layout>
    ...
    <script>
        ...
        function switchMainSection(mainSectionId) {
            ...
            // Якщо перемикаємо на секцію купівлі, забезпечуємо, що її категорія за замовчуванням видима
            ...
            // Якщо перемикаємо на секцію продажу, забезпечуємо, що її категорія за замовчуванням видима
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // switchCategory буде викликано switchMainSection, тому тут не потрібно повторно викликати
